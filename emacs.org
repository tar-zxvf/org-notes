...
*** DONE Learn GTD and improve my current workflow
    CLOSED: [2015-04-01 Wed 18:07] SCHEDULED: <2015-03-22 Sun>
...
**  How to define a global keybinding to override all minor mode and major mode. :emacs:
