...
:PROPERTIES:
:LAST_REPEAT: [2015-10-10 Sat 14:40]
:END:
...
SCHEDULED: <2015-10-11 Sun 09:30-09:50 .+1d>
:LOGBOOK:  
...
SCHEDULED: <2015-10-11 Sun 13:40 .+1d>
:PROPERTIES:
:LAST_REPEAT: [2015-10-10 Sat 11:08]
:END:
...
** STARTED [#B] Create a file-browser package                         :WORK:
...
** TODO [#A]  讨论并定义新的 UI 框架的核心组件和功能组件是哪些？      :WORK:
